...
/**
 * <br>DigitsSum2.java
 * <br>This program tells the user the sum of the cubes of the digits of the positive integer they enter
 * <br>October 29, 2019
 *@author Richard Kha
 */
public class CubesSum {
	...
	public static void main(String[] args) {
		...
		while (counter<userInputString.length()) {	
			...
			sumOfDigits +=  Math.pow((int)((userInput%divisor)/(divisor/10)),3);
			counter++;
		}
